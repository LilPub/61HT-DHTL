<?php  
 ...
 {  
      $connect = mysqli_connect("localhost", "root", "", "dhtl_danhba");  
      $output = '';  
      $allowed_ext = array("csv");
      $ext = explode(".", $_FILES["employee_file"]["name"]);  
      $extension = end($ext); //lấy ra phần tử cuối của mảng sau khi tách chuỗi 
      //user.csv > explode('.','user.csv') > tách chuỗi theo đấu  . ['user','csv']
